...
from zlc_neutral_atom.logic_nodes.readout_common.measurement_values import (duration_axis_for_document, linear_axis_from_range, numeric_axis, optional_trigger, readout_model_kind)
...
TEMPERATURE_RELEASE_RECAPTURE_KEY = DefinitionKey(
    "zlc_neutral_atom.logic_nodes.temperature_release_recapture",

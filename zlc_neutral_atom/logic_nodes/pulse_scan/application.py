...
from zlc_neutral_atom.logic_nodes.pulse_scan.camera_binding import (
...
from zlc_neutral_atom.logic_nodes.occupancy.application import bind_occupancy_pipeline
...
from zlc_neutral_atom.logic_nodes.occupancy.pipeline import (
...
from zlc_neutral_atom.logic_nodes.occupancy.timing import (
...
def _compiled_scan_artifacts_digest(
    ...
    if isinstance(binding, ApiSlotSegmentedCameraBinding):
        return canonical_digest(
            {
                "owner": "zlc_neutral_atom.logic_nodes.pulse_scan.compiled-lineage",
                "artifacts": tuple(
...
def compile_api_occupancy_scan_artifact_plan(
    ...
    *,
    ...
    resolved_source = resolve_occupancy_processor_schema(

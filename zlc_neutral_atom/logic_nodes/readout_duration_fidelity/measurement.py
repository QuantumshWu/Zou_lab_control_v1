...
from zlc_neutral_atom.logic_nodes.readout_common.measurement_values import (duration_axis_for_document, linear_axis_from_range, numeric_axis, optional_trigger, readout_model_kind, scale_authored_value)
...
READOUT_DURATION_FIDELITY_KEY = DefinitionKey(
    "zlc_neutral_atom.logic_nodes.readout_duration_fidelity",
...
READOUT_DURATION_FIDELITY_OUTPUT_DECLARATIONS = (
    DatasetOutputDeclaration(
        "fidelity",
        "zlc_neutral_atom.readout-duration-fidelity.fidelity",
    ),
)

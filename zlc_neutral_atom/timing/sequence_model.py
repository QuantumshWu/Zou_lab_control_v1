...
from .clock import DEFAULT_CLOCK_HZ  # absolute: dependency-free clock seam (config single source)
...
from zlc_data.validation import finite_float, nonnegative_float, positive_float, positive_int
...
def plot_sequence(sequence: PulseSequence, *, clock_hz: float = DEFAULT_CLOCK_HZ, display: bool = True):
    ...
    from zlc_data.viewer_registry import active_plotter

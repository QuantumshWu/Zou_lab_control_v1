...
from .serialization import require_exact_fields as _require_exact_fields
...
# The column spec and the starter-program text are pure description over five
# scalars, so they live at the bottom of the DAG where every scan editor can
# read them without importing this module.  ``scan_column_spec`` below stays
# here: it derives its defaults from the bus range and the clock tick.

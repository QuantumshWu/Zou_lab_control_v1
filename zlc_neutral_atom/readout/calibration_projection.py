...
__all__ = [
    ...
    "CALIBRATION_DIAGNOSTIC_OUTPUT_NAMES",
...
def _diagnostic_snapshot(
    ...
    *,
    ...
    identity = canonical_digest(
        {
            "owner": "zlc_neutral_atom.calibration-diagnostic",
...
def calibration_final_outputs(
    ...
    if tuple(snapshots) != CALIBRATION_FINAL_OUTPUT_NAMES:

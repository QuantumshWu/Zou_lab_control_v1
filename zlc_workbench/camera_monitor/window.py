...
from .projection import (
    CURVE_PANEL_ID as _CURVE_PANEL_ID,
    HISTOGRAM_PANEL_ID as _HISTOGRAM_PANEL_ID,
    IMAGE_PANEL_ID as _IMAGE_PANEL_ID,
    MonitorViewProjection as _PreparedMonitorView,
    RAW_PROJECTION_TEXT as _RAW_PROJECTION_TEXT,
    SCALAR_PANEL_IDS as _SCALAR_PANEL_IDS,
    prepare_monitor_view_projection as _prepare_monitor_view,
    scalar_documents as _scalar_documents,
)
...
__all__ = ["CameraMonitorWorkbenchWindow"]

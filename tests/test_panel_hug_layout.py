...
top-left and ``_compact`` gravity-packs them (no column grid, #H3s-F8).
...
from Zou_lab_control.frontend.task_console import (
    GAP, PanelConfig, _aabb, _card_size, _cell_size, _compact)
...
def test_board_is_pixel_plane_col_and_row_are_pixels():
    ...
    _compact([a, b], board_w=_one_col())                     # one column -> they stack

...
class LiveDefaults:
    ...
    def __post_init__(self) -> None:
        intervals = tuple(
            _positive_integer(value, "refresh interval")
...
class InteractionDefaults:
    ...
    selector_fit_update_interval_ms: int
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(
            self,
            "selector_fit_update_interval_ms",
            _positive_integer(
                self.selector_fit_update_interval_ms,
                "selector_fit_update_interval_ms",
            ),
        )
        object.__setattr__(
...
DEFAULTS = PlotLibraryDefaults(
    ...
    interaction=InteractionDefaults(
        ...
        selector_fit_update_interval_ms=100,

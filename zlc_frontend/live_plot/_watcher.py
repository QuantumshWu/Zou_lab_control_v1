...
from ._validate import _non_negative_int, positive_float, _strict_bool
...
class ArrayWatcher:
    ...
    def __init__(
        ...
        *,
        ...
        self.interval = positive_float(interval if interval is not None else getattr(live_plot, "update_time", 0.1), "watch_interval")

...
if defined ZLC_PY_CMD goto zlc_python_found
echo ERROR: Python was not found. Set ZLC_FPGA_SERVER_PYTHON.
exit /b 1
:zlc_python_found
...
if defined ZLC_PS_VIVADO_BIN goto zlc_vivado_found
echo ERROR: Vivado was not found for the jtag-axi transport. Set ZLC_PS_VIVADO_BIN.
exit /b 1
:zlc_vivado_found
echo ZLC Vivado transport executable: %ZLC_PS_VIVADO_BIN%
exit /b 0

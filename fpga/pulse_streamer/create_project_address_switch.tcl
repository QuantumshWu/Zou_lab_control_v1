...
puts "ZLC create_project_address_switch contract: CHANNEL_COUNT=62 MAX_EDGES=512 MAX_SCAN_POINTS=256 MAX_BUS_SEGMENTS=64 BUS_COUNT=4 BUS_WIDTH=10 EDGE_ADDR_WIDTH=9 SCAN_ADDR_WIDTH=8 BUS_SEG_ADDR_WIDTH=6"

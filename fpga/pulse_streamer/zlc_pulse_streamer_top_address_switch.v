`timescale 1ns / 1ps
// Address-switch pin-map top wrapper for zlc_pulse_streamer.
//
// The file name is kept for backward compatibility with older scripts, but the
// hardware contract is now inferred from the historical address_switch XDC:
...
module zlc_pulse_streamer_top_address_switch(
    ...
    wire zlc_start;
    wire zlc_prog_we;
    wire [8:0] zlc_prog_addr;
    wire [31:0] zlc_prog_tick;
    wire signed [15:0] zlc_prog_tick_x_coeff;
    wire signed [15:0] zlc_prog_tick_y_coeff;
    wire [CHANNEL_COUNT-1:0] zlc_prog_mask;
    wire [9:0] zlc_prog_count;
    wire zlc_repeat_forever;
    wire [8:0] zlc_loop_start_addr;
    wire [31:0] zlc_loop_end_tick;
    wire signed [15:0] zlc_loop_end_x_coeff;
    wire signed [15:0] zlc_loop_end_y_coeff;
    wire [31:0] zlc_loop_count;
    wire zlc_scan_enable;
    wire zlc_scan_prog_we;
    wire [7:0] zlc_scan_prog_addr;
    wire signed [31:0] zlc_scan_prog_x;
    wire signed [31:0] zlc_scan_prog_y;
    wire [39:0] zlc_scan_prog_bus_values;
    wire [8:0] zlc_scan_count;
    ...
    zlc_pulse_streamer #(
        ...
        .prog_tick_x_coeff(zlc_prog_tick_x_coeff),
        .prog_tick_y_coeff(zlc_prog_tick_y_coeff),
        ...
        .loop_end_x_coeff(zlc_loop_end_x_coeff),
        .loop_end_y_coeff(zlc_loop_end_y_coeff),
        .loop_count(zlc_loop_count),
        .scan_enable(zlc_scan_enable),
        .scan_prog_we(zlc_scan_prog_we),
        .scan_prog_addr(zlc_scan_prog_addr),
        .scan_prog_x(zlc_scan_prog_x),
        .scan_prog_y(zlc_scan_prog_y),
        .scan_prog_bus_values(zlc_scan_prog_bus_values),
    ...
    vio_0 zlc_vio_i (
        ...
        .probe_out11(zlc_prog_tick_x_coeff),
        .probe_out12(zlc_prog_tick_y_coeff),
        .probe_out13(zlc_scan_enable),
        .probe_out14(zlc_scan_prog_we),
        .probe_out15(zlc_scan_prog_addr),
        .probe_out16(zlc_scan_prog_x),
        .probe_out17(zlc_scan_prog_y),
        .probe_out18(zlc_scan_count),
        .probe_out19(zlc_loop_end_x_coeff),
        .probe_out20(zlc_loop_end_y_coeff),
        .probe_out21(zlc_bus_prog_we),
        .probe_out22(zlc_bus_prog_bus),
        .probe_out23(zlc_bus_prog_addr),
        .probe_out24(zlc_bus_prog_start_tick),
        .probe_out25(zlc_bus_prog_stop_tick),
        .probe_out26(zlc_bus_prog_start_value),
        .probe_out27(zlc_bus_prog_stop_value),
        .probe_out28(zlc_bus_prog_mode),
        .probe_out29(zlc_bus_counts),
        .probe_out30(zlc_scan_prog_bus_values)
    );
endmodule

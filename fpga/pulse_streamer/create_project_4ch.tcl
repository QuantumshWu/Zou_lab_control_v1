...
set project_dir [file join $script_dir build zlc_pulse_streamer_4ch]
set project_name zlc_pulse_streamer_4ch
set top zlc_pulse_streamer_top_4ch
...
read_verilog [file join $script_dir zlc_pulse_streamer_top_4ch.v]
read_xdc [file join $script_dir zlc_pulse_streamer_4ch.xdc]

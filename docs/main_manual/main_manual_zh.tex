...
\begin{document}
\frontmatter
\zlctitlepage{Zou\_lab\_control 主手册}{notebook-first + PyQt GUI + remote FPGA pulse-streamer 系统总览}{架构、session/devices/timing 分层、sequencer 生命周期、真实硬件 runbook 与 N-slot 扫描模型}{2026-06-09}
\tableofcontents
\cleardoublepage
\mainmatter

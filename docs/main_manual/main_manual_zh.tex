...
默认工程在 \filepath{fpga\build\pulse_streamer}，bit/ltx（\filepath{zlc_pulse_streamer_top.bit/.ltx}）在其 \filepath{impl_1} 目录下。默认 XDC 是 address-switch 板的引脚图（\filepath{addre.xdc}）。相机成像预设的关键物理输出：
...
Host:    0.0.0.0:18861
Backend: jtag-axi
Project: ...\fpga\build\pulse_streamer

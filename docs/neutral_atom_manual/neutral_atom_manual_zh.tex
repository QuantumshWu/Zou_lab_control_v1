...
\begin{document}
\frontmatter
\zlctitlepage{Zou\_lab\_control.neutral\_atom 轻量教程}{Jupyter-first camera / sitemap / threshold / detection session}{中性原子实验控制最小闭环、frontend 画图接口和后续扩展边界}{2026-06-01}
\tableofcontents
\cleardoublepage
\mainmatter
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.84\textwidth]{assets/pulse_sequence.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.72\textwidth]{assets/capture.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.76\textwidth]{assets/sitemap.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.78\textwidth]{assets/threshold.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.74\textwidth]{assets/detect.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.80\textwidth]{assets/detection_scan.png}

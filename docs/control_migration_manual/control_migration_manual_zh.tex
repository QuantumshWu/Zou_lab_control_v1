...
新写法：
\begin{codeblock}[Python]
dev = na.load_devices("virtual")  # or real_template/custom JSON
...
sequencer = na.VerilogSequencer(
    ...
    pin_map={"trap": "M17", "probe": "N15", "qcm_trigger": "R17"},

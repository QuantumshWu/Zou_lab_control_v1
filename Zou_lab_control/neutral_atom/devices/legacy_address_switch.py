...
def write_vivado_vio_tcl(
    ...
    *,
    ...
    lines = [
        ...
        "    error \"Vivado hardware Tcl commands are unavailable. Install/enable Vivado LabTools or set ZLC_VIVADO_BIN to a Vivado with Hardware Manager support.\"",
        "}",
        "if {$hw_server_url ne \"\"} {",
        "    connect_hw_server -url $hw_server_url",
        "} elseif {[catch {connect_hw_server -allow_non_jtag} zlc_connect_error]} {",
        "    puts \"connect_hw_server -allow_non_jtag failed; retrying without option: $zlc_connect_error\"",
        "    connect_hw_server",
        "}",

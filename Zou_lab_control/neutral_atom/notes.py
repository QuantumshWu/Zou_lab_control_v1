...
seq = seq.delay("trig", 4e-9)
\end{{codeblock}}

默认 imaging sequence 包含 \pyapi{{trap}}、可选 \pyapi{{cooling}}、\pyapi{{probe}} 和 \pyapi{{emCCD}}。sequence 本身不接触 camera，也不直接写 Verilog；它只是可验证的 timing source of truth。

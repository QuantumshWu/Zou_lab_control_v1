...
#: (one camera trigger) -- NOT the Calibrate task's long-short-long bracket.  The shipped
#: file's path is typed ONCE, in the timing layer beside its in-memory factory.

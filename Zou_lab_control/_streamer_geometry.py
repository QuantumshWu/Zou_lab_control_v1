"""MOVED to :mod:`zlc_neutral_atom.timing.streamer_geometry` (backend clearance; this shim dies at Z0).
...
import zlc_neutral_atom.timing.streamer_geometry as _moved
